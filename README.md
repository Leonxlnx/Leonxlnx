...
Taste Skill helps **Cursor**, **Codex**, **Claude Code**, **Devin**, and other AI coding harnesses create better frontends with stronger layout, typography, spacing, hierarchy, motion, and overall design direction.

**Taste Skill v2** is focused on stronger design taste, sharper frontend patterns, and cleaner results across AI coding tools.

<p>
  <a href="https://github.com/Leonxlnx/taste-skill">
    <img src="https://img.shields.io/badge/Taste%20Skill-Repository-111827?style=for-the-badge&logo=github&logoColor=white" alt="Taste Skill repository" />
  </a>
  <a href="https://tasteskill.dev">
    <img src="https://img.shields.io/badge/tasteskill.dev-Website-238636?style=for-the-badge" alt="Visit tasteskill.dev" />
  </a>
...
Taste Skill is a small, practical skill system for frontend taste: less generic AI output, more intentional interface design.

It focuses on the details that make AI-built products feel real: layout decisions, type scale, spacing rhythm, interaction polish, visual hierarchy, and motion direction.
...
<p>
  <a href="https://www.star-history.com/leonxlnx/taste-skill">
    <picture>
      ...
      <img alt="Taste Skill star history" src="https://api.star-history.com/badge?repo=Leonxlnx/taste-skill" />
    </picture>
  </a>
</p>
...
Taste Skill is free and open-source.

Sponsorship helps fund development, examples, compatibility testing, hosting, and maintenance.

For company sponsorships, visibility, or collabs: **[hello@tasteskill.dev](mailto:hello@tasteskill.dev)**.

Company sponsors can get visibility on the GitHub README and **[tasteskill.dev](https://tasteskill.dev)**.
